...
=====================================================================
================ ABANDON ALL HOPE BEFORE CONTINUING =================
=====================================================================
========                                    .-----.          ========
========         .----------------------.   | === |          ========
========         |.-""""""""""""""""""-.|   |-----|          ========
...
vim.keymap.set('n', '<leader>d', function() vim.diagnostic.open_float() end, { desc = 'Diagnostic float' })
...
vim.keymap.set('i', 'jj', '<Esc>', { desc = 'Double j to esc baby!' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- uncomment to use regular live_grep search, parses everything as text for search
      -- vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' })
      -- live_grep_search accepts command line parameters such as `-g "!director_name" searchterm`
