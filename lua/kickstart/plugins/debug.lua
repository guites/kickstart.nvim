...
return {
  {
    ...
    keys = {
      ...
      { '<leader>bB', function() require('dap').set_breakpoint(vim.fn.input 'Breakpoint condition: ') end, desc = 'Debug: Set Breakpoint' },
      ...
      dap.configurations.python = {
        {
          ...
          request = 'launch',
          name = 'Django Tests',
          program = vim.fn.getcwd() .. '/backend/manage.py', -- Path to manage.py
          args = { 'test' },
        },
        {
          type = 'python',
          ...
          name = 'Django Server',
          program = vim.fn.getcwd() .. '/backend/manage.py', -- Path to manage.py
          args = { 'runserver', '--noreload' }, -- --noreload is MANDATORY
        },
      }
    end,
  },
